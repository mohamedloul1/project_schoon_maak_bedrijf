...
<html lang="en">
  ...
  <div class="diensten-back">
        ...
        <h3 class="text-center">Hier hebben wij alle diensten met betrekking tot schoonmaak <br> 
        <br>
        ...
        <br>
        Hieronder ziet u een aantal van de diensten die wij doen<br>
        <br>
        als u een andere dienst heeft, kunt u contact met ons opnemen.
      ...
      <div class="container">
        ...
        <div class="card-1">
          ...
          <div class="card-body">
            ...
            <h4 class="text-center">Maak in het algemeen alles wat je wilt op een goede manier schoon</h4>
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-4" id="Bouwoplevering">
        <div class="card-1">
          ...
          <div class="card-body">
            ...
            <h4 class="text-center"> Wij verwijderen al het puin en maken uw gebouw, kantoor of huis grondig schoon</h4>
            <div class="col-md-12 text-center">
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-4" id="Glasbewassing">
        <div class="card-1">
          ...
          <div class="card-body">
            ...
            <h4 class="text-center">Het schoonmaken van ramen Wij polijsten alle soorten glas, en hier is veiligheid zeer belangrijk voor ons</h4>
            <div class="col-md-12 text-center">
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-4" id="Vloeronderhoud">
        <div class="card-2">
          ...
          <div class="card-body">
            ...
            <h4 class="text-center">Wij reinigen en onderhouden vloeren met materialen die geschikt zijn voor de kwaliteit van de vloer</h4>
            <div class="col-md-12 text-center">
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-4" id="Gevelreiniging">
        <div class="card-2">
          ...
          <div class="card-body">
            ...
            <h4 class="text-center">De gevels zijn de impressionistische vorm, dankzij de ervaring ons team behandelt alle gevels</h4>
            <div class="col-md-12 text-center">
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-4" id="Ontruiming">
        <div class="card-2">
          ...
          <div class="card-body">
            ...
            <h4 class="text-center">Ons team staat in voor het leegmaken van uw kantoor of woning met grote nauwkeurigheid</h4>
            <div class="col-md-12 text-center">
