...
iconDonkerMode.onclick = () => {
  ...
  if (document.querySelector(".donker-mode")) {
    document
      .querySelector(".dark-mode-siwtch")
      .classList.replace("fa-lightbulb", "fa-moon");
  } else {
    document
      .querySelector(".dark-mode-siwtch")
      .classList.replace("fa-moon", "fa-lightbulb");
  }
};
...
function validate() {
  ...
  if (name.length == 0) {
    errorName.innerHTML =
      "<i class='fa-solid fa-circle-check'></i> enter your name";
    document.getElementById("naam").style.border = "2px solid red";
    return false;
  } else if (!name.match(/^[A-Za-z]*\s{1}[A-Za-z]*$/)) {
    errorName.innerHTML =
      "<i class='fa-solid fa-circle-check'></i>Write full name";
    document.getElementById("naam").style.border = "2px solid red";
    return false;
  } else {
...
function validateEmail() {
  ...
  if (email.length == 0) {
    errorEmail.innerHTML =
      "<i class='fa-solid fa-circle-check'></i> enter your email";
    ...
    errorEmail.innerHTML =
      "<i class='fa-solid fa-circle-check'></i> type meaningful email";
    document.getElementById("email").style.border = "2px solid red";
    return false;
  } else {
...
function validatePhone() {
  ...
  if (phone.length == 0) {
    errorPhone.innerHTML =
      "<i class='fa-solid fa-circle-check'></i> enter your phonenumber";
    ...
    errorPhone.innerHTML =
      "<i class='fa-solid fa-circle-check'></i>  type meaningful phonenumber";
    document.getElementById("telefoonnummer").style.border = "2px solid red";
    return false;
  } else {
...
function validateMessage() {
  ...
  if (message == 0) {
    errorMessage.innerHTML =
      "<i class='fa-solid fa-circle-check'></i> enter your message";
...
function validateForm() {
  if (
    !(validate() || validateEmail() || validatePhone() || validateMessage())
  ) {
...
window.addEventListener("scroll", () => {
  ...
  if (Math.ceil(scrolled) === scrollable) {
    document
      .querySelector(".wahtsapp-container")
      .classList.add("whatsapp-active");
  } else {
    document
      .querySelector(".wahtsapp-container")
      .classList.remove("whatsapp-active");
  }
});
...
window.addEventListener("scroll", () => {
  ...
  if (Math.ceil(scrolled) === scrollable) {
    document
      .querySelector(".wahtsapp-container-mobile-device")
      .classList.add("whatsapp-active");
  } else {
    document
      .querySelector(".wahtsapp-container-mobile-device")
